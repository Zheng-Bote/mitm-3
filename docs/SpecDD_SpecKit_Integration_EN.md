# Integration Matrix: SpecDD × GitHub Spec Kit for mitm-3

This document defines how architecture specification (SpecDD) and feature specification (GitHub Spec Kit) work together in the `mitm-3` project.
...
## 4. Artifact Mapping for mitm-3

| mitm-3 Area   | SpecDD                        | Spec Kit                          |
| ------------- | ----------------------------- | --------------------------------- |
...
All Spec Kit features MUST adhere to the strict baseline standards defined in `mitm-3.sdd` and `GEMINI.md`. AI agents and developers must not generate code that violates these:
