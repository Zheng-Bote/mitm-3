# Integrationsmatrix: SpecDD × GitHub Spec Kit für mitm-3

Dieses Dokument definiert, wie im `mitm-3` Projekt die Architekturspezifikation (SpecDD) und die Featurespezifikation (GitHub Spec Kit) zusammenarbeiten.
...
## 4. Artefakt-Mapping für mitm-3

| mitm-3 Bereich | SpecDD                        | Spec Kit                            |
| -------------- | ----------------------------- | ----------------------------------- |
...
Alle Spec Kit Features MÜSSEN die strikten Basisstandards einhalten, die in der `mitm-3.sdd` und `GEMINI.md` definiert sind. KI-Agenten und Entwickler dürfen keinen Code generieren, der diese verletzt:
